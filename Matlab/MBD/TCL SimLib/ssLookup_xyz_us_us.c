/*
 *   ssLookup_xyz_us_us.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy 
 *     function during simulation:
 *
 *        uint16 y1 = ssLookup_xyz_us_us(uint16 u1[1], uint16 u2, uint16 u3)
 *
 *   Simulink version           : 6.6 (R2007a) 01-Feb-2007
 *   C source code generated on : 04-Jul-2007 10:20:53
 */

/*
   %%%-MATLAB_Construction_Commands_Start
   def = legacy_code('initialize');
   def.SFunctionName = 'ssLookup_xyz_us_us';
   def.OutputFcnSpec = 'uint16 y1 = ssLookup_xyz_us_us(uint16 u1[1], uint16 u2, uint16 u3)';
 ...
 */
#define S_FUNCTION_NAME                 ssLookup_xyz_us_us
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
   ...
   */
  //*y1 = ssLookup_xyz_us_us( u1, *u2, *u3);
}
