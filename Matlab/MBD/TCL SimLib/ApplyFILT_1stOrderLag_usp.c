/*
 *   ApplyFILT_1stOrderLag_usp.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy 
 *     function during simulation:
 *
 *        uint16 y1 = ApplyFILT_1stOrderLag_usp(uint16 u1, uint16 u2, uint16 u3)
 *
 *   Simulink version           : 6.6 (R2007a) 01-Feb-2007
 *   C source code generated on : 11-Jul-2007 15:52:50
 */
...
static uint16_T AppFILT_1stOrderLag_usp(uint16_T *LfFILT_Old,
                                        uint16_T *LfFILT_New,
                                        uint16_T *LfFILT_k_Coeff )
  {
  uint16_T LfFILT_Result;
  uint32_T LfFILT_TempResult;
     ...
     || (LfFILT_k_Coeff == 0) )
  ...
  else if (*LfFILT_New > *LfFILT_Old)
      {
          ...
          //ssPrintf("LfFILT_TempResult (case New > Old) = %i;\n",LfFILT_TempResult);
 		  ...
 		  LfFILT_Result=(uint16_T)(LfFILT_TempResult>>16); //Fixed point type T_FILTER
          if (LfFILT_Result == 0)
              {
  ...
  else /* if (LfFILT_New < LfFILT_Old) */
      {
         ...
         LfFILT_TempResult=(uint32_T)(*LfFILT_k_Coeff * LfFILT_Result);
         //ssPrintf("LfFILT_TempResult (case New < Old) = %i;\n",LfFILT_TempResult);         
 		 LfFILT_Result=(uint16_T)(LfFILT_TempResult>>16); //Fixed point type T_FILTER
         if (LfFILT_Result == 0)
              {
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
   ...
   */
  *y1 = AppFILT_1stOrderLag_usp( u1, u2, u3);
}
