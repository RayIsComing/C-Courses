/*
 *   usLookup_Independent_xy_ss.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy 
 *     function during simulation:
 *
 *        uint16 y1 = usLookup_Independent_xy_ss(uint16 u1[1], uint16 u2)
 *
 *   Simulink version           : 6.6 (R2007a) 01-Feb-2007
 *   C source code generated on : 05-Jul-2007 11:46:13
 */

/*
   %%%-MATLAB_Construction_Commands_Start
   def = legacy_code('initialize');
   def.SFunctionName = 'usLookup_Independent_xy_ss';
   def.OutputFcnSpec = 'uint16 y1 = usLookup_Independent_xy_ss(uint16 u1[1], uint16 u2)';
 ...
 */
#define S_FUNCTION_NAME                 usLookup_Independent_xy_ss
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
   ...
   */
  //*y1 = usLookup_Independent_xy_ss( u1, *u2);
}
