/*
 *   ssLookup_xy_us.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy 
 *     function during simulation:
 *
 *        int16 y1 = ssLookup_xy_us(int16 u1[1], uint16 u2)
 *
 *   Simulink version           : 6.6 (R2007a) 01-Feb-2007
 *   C source code generated on : 25-Jun-2007 11:13:30
 */
 ...
 */
#define S_FUNCTION_NAME                 ssLookup_xy_us
