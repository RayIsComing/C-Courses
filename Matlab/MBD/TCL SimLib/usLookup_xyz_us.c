/*
 *   usLookup_xyz_us.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy 
 *     function during simulation:
 *
 *        uint16 y1 = usLookup_xyz_us(uint16 u1[1], uint16 u2, uint16 u3)
 *
 *   Simulink version           : 6.6 (R2007a) 01-Feb-2007
 *   C source code generated on : 04-Jul-2007 10:13:09
 */

/*
   %%%-MATLAB_Construction_Commands_Start
   def = legacy_code('initialize');
   def.SFunctionName = 'usLookup_xyz_us';
   def.OutputFcnSpec = 'uint16 y1 = usLookup_xyz_us(uint16 u1[1], uint16 u2, uint16 u3)';
 ...
 */
#define S_FUNCTION_NAME                 usLookup_xyz_us
