/*
 *   usLookup_Independent_xy_us.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy 
 *     function during simulation:
 *
 *        uint16 y1 = usLookup_Independent_xy_us(uint16 u1[1], uint16 u2)
 *
 *   Simulink version           : 6.6 (R2007a) 01-Feb-2007
 *   C source code generated on : 03-Jul-2007 14:14:57
 */
 ...
 */
#define S_FUNCTION_NAME                 usLookup_Independent_xy_us
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
   ...
   */
  //*y1 = usLookup_Independent_xy_us( u1, *u2);
}
