/*
 *   usLookup_xy_us.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy 
 *     function during simulation:
 *
 *        uint16 y1 = usLookup_xy_us(uint16 u1[1], uint16 u2)
 *
 *   Simulink version           : 6.6 (R2007a) 01-Feb-2007
 *   C source code generated on : 21-Jun-2007 13:22:29
 */

/*
   %%%-MATLAB_Construction_Commands_Start
   def = legacy_code('initialize');
   def.SFunctionName = 'usLookup_xy_us';
   def.OutputFcnSpec = 'uint16 y1 = usLookup_xy_us(uint16 u1[1], uint16 u2)';
 ...
 */
#define S_FUNCTION_NAME                 usLookup_xy_us
 ...
 */
#include "C:\DATA\aw_Projects\DIG_Function_Dev\WRAF\WRAF_Autocoding_WRFIMODE\mathlib.h"
