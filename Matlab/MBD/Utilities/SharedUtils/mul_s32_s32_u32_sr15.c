/*
 * File: C:\EMS\Autocode\Diesel_Autocode_pojects\US_Gas\projFiles\simulink\models\tse_gpf_temp_est_files\slprj\ert\_sharedutils\mul_s32_s32_u32_sr15.c
 *
...
S32 mul_s32_s32_u32_sr15(S32 a, U32 b)
{
  U32 u32_chi;
  U32 u32_clo;
  mul_wide_su32(a, b, &u32_chi, &u32_clo);
  u32_clo = u32_chi << 17U | u32_clo >> 15U;
  return (S32)u32_clo;
}
