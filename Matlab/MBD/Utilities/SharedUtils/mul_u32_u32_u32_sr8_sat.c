/*
 * File: C:\cvs\GDi_Documentation_JUS\EMS_Core\VVTS\slprj\ert\_sharedutils\mul_u32_u32_u32_sr8_sat.c
 *
...
uint32_T mul_u32_u32_u32_sr8_sat(uint32_T a, uint32_T b)
{
  uint32_T result;
  uint32_T u32_chi;
  uint32_T u32_clo;
  mul_wide_u32(a, b, &u32_chi, &u32_clo);
  u32_clo = u32_chi << 24 | u32_clo >> 8;
  u32_chi = u32_chi >> 8;
  if(u32_chi) {
    result = MAX_uint32_T;
  } else {
