/*
 *   SfuncApplyFILT_1stOrderLagIfEnbld_ssp.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        single y1 = ApplyFILT_1stOrderLagIfEnbld_ssp(single u1, single u2, single u3)
 *
...
/*
   ...
   def.SFunctionName = 'SfuncApplyFILT_1stOrderLagIfEnbld_ssp';
   def.OutputFcnSpec = 'single y1 = ApplyFILT_1stOrderLagIfEnbld_ssp(single u1, single u2, single u3)';
   def.HeaderFiles = {'ApplyFILT_1stOrderLagIfEnbld_ssp.h'};
   def.SourceFiles = {'ApplyFILT_1stOrderLagIfEnbld_ssp.c'};
 ...
 */
#define S_FUNCTION_NAME                SfuncApplyFILT_1stOrderLagIfEnbld_ssp
 ...
 */
#include "ApplyFILT_1stOrderLagIfEnbld_ssp.h"
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S)) {
     ...
     */
    ssRegMdlInfo(S, "ApplyFILT_1stOrderLagIfEnbld_ssp", MDL_INFO_ID_RESERVED, 0,
                 0, ssGetPath(S));
  }
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  // uint16_T *u13 = (uint16_T *) ssGetInputPortSignalPtrs(S, 2);
			...
			int16_T *y1 = (int16_T *) ssGetOutputPortSignal(S, 0);
  			InputInt16PtrsType  u11  = (InputInt16PtrsType)u0ptrs;
			InputInt16PtrsType  u12  = (InputInt16PtrsType)u1ptrs;
...
//  *y1 = ApplyFILT_1stOrderLagIfEnbld_usp_fixed( *u1, *u2, *u3);
  ...
  {
    y1[0] = ApplyFILT_1stOrderLag_ssp_fixed( *u11[0], *u12[0], *u13[0] );
  }
...
//  *y1 = ApplyFILT_1stOrderLagIfEnbld_usp_fixed( *u1, *u2, *u3);
  ...
  {
    y1[0] = ApplyFILT_1stOrderLag_ssp( *u21[0], *u22[0], *u23[0] );
  }
