/*
 * File: SFcn_SlLookup_indx_indx.c
 *
 *
 *
...
#define S_FUNCTION_NAME SFcn_SlLookup_indx_indx
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    {
        case FXP_STORAGE_INT32:
            (*((int32_T *)pVoidOut1)) = slLookup_xyz_us_us(((int32_T *)pVoidIn1),*u1,*u2,YWidth,XWidth);
            break;
        default:
