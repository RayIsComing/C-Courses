/*
 * File: SFcn_UlLookup_indx_indx.c
 *
 *
 *
...
#define S_FUNCTION_NAME SFcn_UlLookup_indx_indx
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    {
        case FXP_STORAGE_UINT32:
            (*((uint32_T *)pVoidOut1)) = ulLookup_xyz_us_us(((uint32_T *)pVoidIn1),*u1,*u2,YWidth,XWidth);
            break;
        default:
