/*
 * File: SFcn_USLookup_indx_indx.c
 *
 *
 *
...
#define S_FUNCTION_NAME SFcn_USLookup_indx_indx
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    {
        case FXP_STORAGE_UINT16:
            (*((uint16_T *)pVoidOut1)) = usLookup_xyz_us_us(((uint16_T *)pVoidIn1),*u1,*u2,YWidth,XWidth);
            break;
        default:
