...
#define S_FUNCTION_NAME SFcn_idx_Lookup_US
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    {
      case FXP_STORAGE_UINT16:
        *y0 = usLookup_Independent_xy_us(((uint16_T *)pVoidIn1), (*((uint16_T *)pVoidIn2)),Intervals);
        break;
      default:
