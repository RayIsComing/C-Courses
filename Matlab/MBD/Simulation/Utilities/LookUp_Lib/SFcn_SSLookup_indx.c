...
#define S_FUNCTION_NAME SFcn_SSLookup_indx
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    {
        case FXP_STORAGE_INT16:
            (*((int16_T *)pVoidOut1)) = ssLookup_xy_us(((int16_T *)pVoidIn1),*u1,Intervals);
            break;
        default:
